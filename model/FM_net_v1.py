...
if __name__ == '__main__':
    ...
    net.export(r'../checkpoints/FM/v1/ok/init', 0)

    sym, _, _ = mx.model.load_checkpoint(r'../checkpoints/FM/v1/ok/init', 0)
    digraph = mx.viz.plot_network(sym, title='v1', save_format='pdf', shape={'data':(1, 3, 128, 128)})
    digraph.view()
