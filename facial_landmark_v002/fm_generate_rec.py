...
class FMGenerateRec(MXRec):
    ...
    @staticmethod
    def generate_rec_file(image_list, rec_dir, rec_prefix, image_shape):
        rec_handler = MXRec(rec_dir=rec_dir, prefix=rec_prefix)
...
if __name__ == '__main__':
    ...
    W, H = 64, 64  # 64, 64  # 128, 128

    if data_type == '300vw':
        root_dir = r'/data1/dataset/300/300vw'
        image_list_file = f'/data1/dataset/300/rec/002/300vw_{W}X{H}.lst'
        rec_dir = r'/data1/dataset/300/rec/002'
        rec_prefix = f'300vw_{W}X{H}'
        ...
        #     image_shape=(H, W)
        # )
        FMGenerateRec.check_rec_file(rec_dir=rec_dir, rec_prefix=rec_prefix)
    elif data_type == '300w':
        root_dir = r'/data1/dataset/300/300w'
        image_list_file = f'/data1/dataset/300/rec/002/300w_{W}X{H}.lst'
        rec_dir = r'/data1/dataset/300/rec/002'
        rec_prefix = f'300w_{W}X{H}'
        # FMGenerateRec.generate_rec_file_with_multi_thread(
        #     image_list=FMGenerateRec.get_image_list(root_dir, image_list_file),
        #     rec_dir=rec_dir,
        #     rec_prefix=rec_prefix,
