...
class FMTrainConfig(TrainConfig):
    def __init__(
        ...
        min_epoch=100,
        max_epoch=150,
        checkpoint_dir=r'../checkpoints/FM/002/epochs/init-64-64',
        pretrained_prefix=r'../checkpoints/FM/002/epochs/init-64-64',  # -sym',
        pretrained_epoch=52,
        batch_size=128,
        log_interval=20,
        ...
        train_rec_prefix=r'300vw_64X64',
        eval_rec_dir=r'/data1/dataset/300/rec/002',
        eval_rec_prefix=r'300w_64X64',
        weight_decay=1e-4,
        learning_rate=1e-3,
