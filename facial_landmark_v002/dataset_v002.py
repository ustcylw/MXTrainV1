...
if __name__ == '__main__':
    ...
    for index, data in enumerate(iter(loader)):
        ...
        print(f'labels1: {labels1.shape}  {type(labels1)}')
        shape = images.shape
        ...
        images = CVShow.cv_draw_batch_points(images.asnumpy(), labels1.asnumpy(), normalized=True, radius=1)
        CVShow.cv_show_images(images, wait_time=300)