...
from config.config_v010 import Config
...
from network.mobilenet_v010 import get_mobilenet_v2
...
def train_v1(opts):
    ...
    ## optimizer
    lr_scheduler = mx.lr_scheduler.FactorScheduler(step=30, factor=0.1, base_lr=opts.learning_rate, stop_factor_lr=1e-6)
